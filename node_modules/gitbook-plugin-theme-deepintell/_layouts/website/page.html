...
{% block head %}
    ...
    <!--<link rel="stylesheet" href="{{ book.linkHref }}" />-->
{% endblock %}
...
{% block body %}
<div class="book">
    <div id="book-header" class="book-header bookBc-header" >
        <span class="bookBc-headLogo"><a style="color: white;" href="http://deepintell.net">{{ book.brand }}</a></span>
        <span class="bookBc_wd">使用文档</span>
    </div>
    <div class="book-summary bookBc_left">
        {% block book_sidebar %}
    ...
    <div class="book-body bookBc_right">
        {% block book_body %}
